    ...
    <div className="min-h-screen flex items-start justify-center bg-white p-4">
      <div className="text-left max-w-full px-8 mx-6">
        ...
        <p className="text-lg mb-4">
          ...
          Policy because it may affect the rights and obligations of the User
          under applicable law.
        </p>
        <p className="text-lg mb-4">
          By registering and/or using the Application, the User is deemed to
          have read, understood, understood and agreed to all contents in the
          Terms of Use of the TOMORO COFFEE Application and also agreed to the
          additional TOMORO COFFEE Application Terms of Use which are an
        ...
        <p className="text-lg mb-4">
          These Terms and Conditions are effective on the date stated in the
          Terms and Conditions. TOMORO COFFEE may change, add, delete, correct
          and/or update these Terms and Conditions at any time by posting the
          revised Terms and Conditions on the Application, where if there is a
          material change, TOMORO COFFEE will change the date at the top of
          these Terms and Conditions; and the User waives any rights that the
          User may have to receive special notices of such changes or
        ...
        <p className="text-lg mb-4">
          ...
          BY ACCESSING, USING THE TOMORO COFFEE APPLICATION, OPENING AN ACCOUNT
          OR PARTICIPATING IN THE TOMORO COFFEE PROGRAM, THE USER IS AGREEING TO
          ACCEPT AND BE BOUND BY THESE TERMS AND CONDITIONS AND THE PRIVACY
          POLICY. IF THE USER DOES NOT AGREE TO ANY, SOME OR ALL OF THESE TERMS
          AND CONDITIONS AND/OR THE PRIVACY POLICY, DO NOT USE THE APPLICATION,
          OPEN ACCOUNTS OR PARTICIPATE THE TOMORO COFFEE PROGRAM IN THE
          APPLICATION.
        </p>
      </div>
    </div>
